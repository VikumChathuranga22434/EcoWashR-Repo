...
<head>
    ...
    <script>
	    function validateForm() {
	        ...
	        if (email === '' || password === '') {
	            alert("Please provide valid credentials. Email and password are required.");
    ...
    <nav class="navbar navbar-dark navbar-expand-md sticky-top py-3" id="mainNav">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="/"><span class="bs-icon-sm bs-icon-circle bs-icon-primary shadow d-flex justify-content-center align-items-center bounce animated me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bezier bounce animated">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                ...
                </ul><a class="btn btn-primary shadow" role="button" onclick="window.location.href='register.jsp';return false;">Sign In</a>
            </div>
        </div>
    </nav>
    <section class="py-5">
                    ...
                    <div class="card">
                        <div class="card-body text-center d-flex flex-column align-items-center">
                            <div class="bs-icon-xl bs-icon-circle bs-icon-primary shadow bs-icon my-4"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-person">
								...
								<form action="LoginControlServlet" method="post" onsubmit="return validateForm();">
								    <input type="hidden" name="command" value="LOGIN">
								    <c:choose>
								        <c:when test="${not empty requestScope.INVALID}">
								            <div class="mb-3"><p class="error">${requestScope.INVALID}</p></div>
								        </c:when>
								    </c:choose>
